...
export default function DCS101() {
            ...
            <div className="space-y-1">
                <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')} className="border border-cyan-400">
                    ...
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                            DCS101 is a professional certification in Defensive Cyber Security, designed to equip learners with essential skills and knowledge to defend against various cyber threats. It covers key concepts such as network security, digital forensic, threat hunting, and incident response.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} className="border border-cyan-400">
                    ...
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                            No prior work experience is required to take the DCS101 certification. It is designed for beginners and those new to the field of cybersecurity, making it accessible to anyone interested in building a strong foundation in defensive security.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} className="border border-cyan-400">
                    ...
                    >
                        <Typography className="w-52 md:m-96 lg:w-full flex-shrink-0">
                            What does the DCS101 Exam Look Like?
                        </Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                            The DCS101 exam is entirely practical, focusing on real-world scenarios where you apply defensive security techniques. In addition to the hands-on tasks, you will also be required to prepare a detailed report to demonstrate your findings and analysis.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} className="border border-cyan-400">
                    ...
                    >
                        <Typography className="w-52 md:m-96 lg:w-full flex-shrink-0">
                            Can I apply the skills learned in this course to real-world scenarios?</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                ...
                <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')} className="border border-cyan-400">
                    <AccordionSummary
                        ...
                        style={{ background: "#0b121f", color: "white" }}
                    >
                        <Typography className="w-52 md:m-96 lg:w-full flex-shrink-0">How Much Time Should I Dedicate to Studying DCS101?</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                            We recommend dedicating at least 5-7 hours per week over a 3-month period to thoroughly understand and master the material covered in the DCS101 course. However, the exact time needed may vary depending on your prior knowledge and experience.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')} className="border border-cyan-400">
                    <AccordionSummary
                        ...
                        style={{ background: "#0b121f", color: "white" }}
                    >
                        <Typography className="w-52 md:m-96 lg:w-full flex-shrink-0">Will I receive a certification upon completion?</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                ...
                <Accordion expanded={expanded === 'panel7'} onChange={handleChange('panel7')} className="border border-cyan-400">
                    <AccordionSummary
                        ...
                        style={{ background: "#0b121f", color: "white" }}
                    >
                        <Typography className="w-52 md:m-96 lg:w-full flex-shrink-0">Does the DCS101 Certification Expire?
                        </Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ background: "#141d2b", color: "white" }} className="border-t border-cyan-400">
                        <Typography>
                            No, the DCS101 Certification does not expire. Once you earn it, you can showcase your knowledge and skills in defensive cybersecurity indefinitely without the need for renewal.
                        </Typography>
                    </AccordionDetails>
                </Accordion>
